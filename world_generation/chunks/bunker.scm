...
(define (generate-walls)
    (if (= height 1)
        (begin
            ...
            (make-park-grass this-chunk (make-area (make-point 2 2) (make-point (- size-x 4) 6)))
            (make-park-grass this-chunk (make-area (make-point 2 8) (make-point 4 6)))
            (make-park-grass this-chunk (make-area (make-point 12 8) (make-point 2 6)))
        ...
        (begin
            ...
            (let ((chair-index (random-integer 4)))
                (cond
                    ((= chair-index 0) (place-furniture (make-point 7 5) 'wood_chair side-up))
                    ((= chair-index 1) (place-furniture (make-point 6 5) 'wood_chair side-up))
                    ((= chair-index 2) (place-furniture (make-point 7 7) 'wood_chair side-down))
                    (else (place-furniture (make-point 6 7) 'wood_chair side-down))))
