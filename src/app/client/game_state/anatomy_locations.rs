...
impl UiAnatomyLocations
{
    ...
    ) -> Self
    {
        ...
        let color_pairs: HashMap<HumanPartId, Rgba<u8>> = [
            ...
            (HumanPartId::UpperArm(Side1d::Right), 0xff1493),
            (HumanPartId::UpperArm(Side1d::Left), 0xff8c00),
            (HumanPartId::LowerArm(Side1d::Right), 0x8b0000),
            (HumanPartId::LowerArm(Side1d::Left), 0xffff00),
            (HumanPartId::Hand(Side1d::Right), 0x008000),
            (HumanPartId::Hand(Side1d::Left), 0x7fff00),
            (HumanPartId::UpperLeg(Side1d::Right), 0xe9967a),
            (HumanPartId::UpperLeg(Side1d::Left), 0x0000ff),
            (HumanPartId::LowerLeg(Side1d::Right), 0x00ffff),
            (HumanPartId::LowerLeg(Side1d::Left), 0xff00ff),
