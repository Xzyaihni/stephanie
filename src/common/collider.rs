...
impl ColliderLayer
{
    pub fn collides(&self, other: &Self) -> bool
    {
        define_layers!{
            ...
            (DoorTrigger, DoorTrigger, false),
            (DoorTrigger, Normal, false),
            (DoorTrigger, Damage, false),
            (DoorTrigger, World, false),
            (DoorTrigger, Mouse, false),
            ...
            (PathfindEnemy, DoorTrigger, false),
