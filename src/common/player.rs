...
pub const DAMAGE_SCREENSHAKE: f32 = WEAKER_SCREENSHAKE;
pub const FALL_SCREENSHAKE: f32 = WEAK_SCREENSHAKE;

pub const DESTROY_SCREENSHAKE: f32 = MEDIUM_SCREENSHAKE;
pub const TILE_DESTROY_SCREENSHAKE: f32 = MEDIUM_SCREENSHAKE;

pub const TILE_DAMAGE_SCREENSHAKE: f32 = WEAK_SCREENSHAKE;
pub const PLAYER_DAMAGE_SCREENSHAKE: f32 = MEDIUM_SCREENSHAKE;
